...
public:
    ...
    using Rule = ncmay::Rule;
    using ChessData = ncmay::ChessData;
    using Phases = ncmay::Phases;
    using Actions = ncmay::Actions;
    using Players = ncmay::Players;
    using Rotates = ncmay::Rotates;
    using MillKey = ncmay::MillKey;

    // 兼容旧代码中通过类名访问的公共常量。
    static constexpr int MILL = ncmay::MILL;
    static constexpr int RING = ncmay::RING;
    static constexpr int SEAT = ncmay::SEAT;
    static constexpr int BOARD_SIZE = ncmay::BOARD_SIZE;
    static constexpr int RULE_COUNT = ncmay::RULE_COUNT;
    static constexpr Players NOBODY = ncmay::NOBODY;
    static constexpr Players PLAYER1 = ncmay::PLAYER1;
    static constexpr Players PLAYER2 = ncmay::PLAYER2;
    static constexpr Players DRAW = ncmay::DRAW;
    static constexpr Phases GAME_NOTSTARTED = ncmay::GAME_NOTSTARTED;
    static constexpr Phases GAME_OPENING = ncmay::GAME_OPENING;
    static constexpr Phases GAME_MID = ncmay::GAME_MID;
    static constexpr Phases GAME_OVER = ncmay::GAME_OVER;
    static constexpr Actions ACTION_NONE = ncmay::ACTION_NONE;
    static constexpr Actions ACTION_CHOOSE = ncmay::ACTION_CHOOSE;
    static constexpr Actions ACTION_PLACE = ncmay::ACTION_PLACE;
    static constexpr Actions ACTION_CAPTURE = ncmay::ACTION_CAPTURE;
    static constexpr Rotates ROTATE_0 = ncmay::ROTATE_0;
    static constexpr Rotates ROTATE_LEFT = ncmay::ROTATE_LEFT;
    static constexpr Rotates ROTATE_RIGHT = ncmay::ROTATE_RIGHT;
    static constexpr Rotates ROTATE_180 = ncmay::ROTATE_180;
